Ext.define('Admin.view.admin.menu.Menus',{
    extend: 'Ext.container.Container',
    xtype: 'menus',

    requires: [
        'Admin.view.admin.menu.MenusController',
        'Admin.view.admin.menu.MenusModel'
    ],
                ...
                plugins: {
                    ...
                    dropZone: {
                        onNodeDrop: function(targetNode, sourceNode, e, data) {
                            ...
                            if(target.id === source.group_id) {
                                Ext.Msg.alert('提示','不能移动到相同的父节点!');
                                return false;
                            }

                            var id = source.id;
                            var group_id = target.id;
                            var url = '/api/admin/menu/move';
                            Ext.Ajax.request({
                                url: url,
                                params: {
                                    id: id,
